...
const tablesSchema = __schema({
  live_book_ticker: __table({
    name: 'live_book_ticker',
    indexes: [
      { accessor: 'symbol', name: 'live_book_ticker_symbol_idx_btree', algorithm: 'btree', columns: [
        'symbol',
      ] },
    ],
    constraints: [
      { name: 'live_book_ticker_symbol_key', constraint: 'unique', columns: ['symbol'] },
    ],
  }, LiveBookTickerRow),
  live_kline: __table({
    name: 'live_kline',
    indexes: [
      { accessor: 'id', name: 'live_kline_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'symbol', name: 'live_kline_symbol_idx_btree', algorithm: 'btree', columns: [
        'symbol',
      ] },
    ],
    constraints: [
  ...
  live_trade: __table({
    name: 'live_trade',
    indexes: [
      { accessor: 'symbol', name: 'live_trade_symbol_idx_btree', algorithm: 'btree', columns: [
        'symbol',
      ] },
    ],
    constraints: [
      { name: 'live_trade_symbol_key', constraint: 'unique', columns: ['symbol'] },
    ],
  }, LiveTradeRow),
});
